...
data_arg.add_argument('--train_path', type=str, default='./dataset/train_tisv', help="train dataset directory")
data_arg.add_argument('--test_path', type=str, default='./dataset/test_tisv', help="test dataset directory")
