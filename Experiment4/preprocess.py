...
from Experiment4.configuration import get_config
from Experiment4.utils import keyword_spot

config = get_config()   # get arguments from parser

# downloaded dataset path
audio_path = r'E:\DeepLearning_data\VCTK-Corpus\wav48'                                          # utterance dataset
